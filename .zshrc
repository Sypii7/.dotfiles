...
export PATH=/opt/kitty/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:/usr/sbin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl:/opt/nvim/nvim-linux64/bin:/home/sypii/.local/bin:/home/sypii/go/bin:/home/sypii/.pyenv/shims:/home/sypii/.pyenv/bin
...
function powerrevshell(){
  ...
  if [[ $# -eq 2 ]]; then
    ...
    port="$1"
    echo -e "\n${yellowColour}[+]${endColour} ${blueColour}IP address for tun0:${endColour} ${purpleColour}$ip${endColour}"
  fi
